...
[cite_start]Wie in der Aufgabe empfohlen[cite: 158], habe ich Redis für das Caching aktiviert, um die Gesamtleistung von Nextcloud zu verbessern. (da ich schon vorher mit Redis Erfahrung habe) - 
